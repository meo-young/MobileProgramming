...
class Person2(val name:String, val addr:String, val tel:String){
    constructor(name:String, addr:String):this(name,addr,"c")
    constructor(name:String):this(name,"b","c")
    constructor():this("a","b","c")
